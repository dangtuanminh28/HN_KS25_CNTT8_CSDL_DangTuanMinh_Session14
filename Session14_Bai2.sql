...
/*
-- Phần A
Đang vi phạm tính Atomicity (Tính nguyên tử) do tính chất này tuân theo quy tắc tất cả hoặc ko gì cả
Nên buộc cả 2 thao tác giải phóng giường cũ và gán giường mới phải được thực hiện chọn vẹn như 1 tính chất duy nhất, ko được phép trạng thái rời rạc
*/
-- Phần B
